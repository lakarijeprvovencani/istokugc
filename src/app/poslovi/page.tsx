    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl 2xl:max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 py-8 lg:py-12">
        <div className="lg:flex lg:gap-12">
          {/* Filters toggle - visible on all screens, hidden for guests */}
          {!isGuest && (
            <button
              onClick={() => setShowFilters(!showFilters)}
              className="w-full lg:w-auto mb-6 py-3 px-5 border border-border rounded-xl flex items-center justify-center gap-2 hover:bg-secondary transition-colors text-sm"
            >
          ...
          <main className="flex-1 min-w-0">
            {/* Results header - hidden for guests */}
            {!isGuest && (
