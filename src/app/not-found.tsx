    ...
    <div className="min-h-screen bg-gradient-to-b from-secondary/50 to-white flex items-center justify-center p-4">
      <div className="max-w-lg w-full text-center">
        ...
        <div className="relative mb-8">
          <div className="text-[180px] sm:text-[220px] font-black text-secondary/80 leading-none select-none">
            404
          </div>
          {/* Decorative element */}
        ...
        {/* Icon */}
        <div className="w-20 h-20 mx-auto bg-primary/10 rounded-full flex items-center justify-center mb-6 -mt-16 relative z-10">
